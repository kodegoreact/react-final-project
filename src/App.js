  ...
  return (
    <>
      ...
      <BrowserRouter>
        ...
        <Banner></Banner>
        <Routes>
          <Route path='/react-final-project/' element={<Body addItems={addItems} products={filteredProducts} filterFunction={filterFunction}></Body>}></Route>
          <Route path='/react-final-project/add' element={<AddProduct AddProductFunction={AddProductFunction}></AddProduct>}></Route>
        </Routes>
      </BrowserRouter>
      <Footer></Footer>
    </>
